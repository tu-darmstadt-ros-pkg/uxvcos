...
set(UXVCOS_INCLUDE_DIRS ${UXVCOS_INCLUDE_DIRS} "${UXVCOS_PATH}/include")
set(UXVCOS_LIBRARY_DIRS ${UXVCOS_LIBRARY_DIRS} "${UXVCOS_PATH}/lib")
set(UXVCOS_LIBRARIES    ${UXVCOS_LIBRARIES} uxvcos)
set(UXVCOS_DEFINITIONS  ${UXVCOS_DEFINITIONS})
set(UXVCOS_DEPENDS      "${UXVCOS_DEPENDS} uxvcos")
...
function(uxvcos_typekit name)
  ...
  if(NOT COMMAND orocos_typekit)
    ...
    add_definitions("-DOROCOS_TYPEKIT")
...
link_directories(${UXVCOS_LIBRARY_DIRS})
...
message(STATUS "  Library directories: ${UXVCOS_LIBRARY_DIRS}")
