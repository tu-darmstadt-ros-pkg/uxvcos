...
ELSE(MSVC)
  SET(MEX_COMPILE_FLAGS "-DMATLAB_MEX_FILE -D_GNU_SOURCE -fPIC -fno-omit-frame-pointer -pthread -D_FILE_OFFSET_BITS=64 -DMX_COMPAT_32")
  IF(APPLE)
    SET(MEX_LINK_FLAGS "-L${MATLAB_SYS} -Wl,-flat_namespace -undefined suppress")
  ELSE(APPLE)
    SET(MEX_LINK_FLAGS "-L${MATLAB_SYS} -Wl,-rpath ${MATLAB_SYS} -Wl,-E -Wl,--no-undefined")
  ENDIF(APPLE)
ENDIF(MSVC)
